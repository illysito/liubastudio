...
void main() {
  ...
  vec4 white = vec4(1.0, 0.98, 0.96, 1.0);
  vec4 semi_blue = rgb(vec4(20.0, 10.0, 200.0, 255.0));
  vec4 blue = rgb(vec4(49.0, 17.0, 213.0, 255.0));

  vec4 colors[3] = vec4[](white, semi_blue, blue);
